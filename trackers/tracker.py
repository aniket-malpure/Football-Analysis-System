...
class Tracker:
    ...
    def draw_ellipse(self, frame, bbox, color, track_id=None):
        ...
        if track_id is not None:
            ...
            cv2.putText(
                frame,
                f"{track_id}",
                (int(x1_text), int(y1_rect+15)),  # Position of text in rectangle
    ...
    def draw_annotations(self, video_frames, tracks, team_ball_control):
        ...
        for frames_num, frame in enumerate(video_frames):
            ...
            player_dict = tracks['players'][frames_num]
            ball_dict = tracks['ball'][frames_num]
            referee_dict = tracks['referees'][frames_num]
